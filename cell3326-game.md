...
**[v1.2.3 от 19.11.2025]**:

Решил выложить немного обновлений, большинство из которых накопились уже давно, но выкладываются только сейчас.

- сборка скриптов программы происходит в папочку output как в более современной версии zx-core
...
- если игрок пробует надать еще один скафандр выводится предупреждение SCAF_ALREADY_WEAR
